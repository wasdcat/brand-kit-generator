...
(function () {
  ...
  const en = {
    ...
    'cs.assignmentNote': 'Which of the colours above a design object uses – no extra colour, just a reference.',
    'cs.note': 'A colour set defines the colour values and maps them to individual design objects. Everything else is decided by the CSS of the template.',
  ...
  const de = {
    ...
    'cs.assignmentNote': 'Welche der obigen Farben ein Designobjekt verwendet – keine zusätzliche Farbe, nur ein Verweis.',
    'cs.note': 'Ein Farbset definiert die Farbwerte und weist sie einzelnen Designobjekten zu. Alles Weitere entscheidet das CSS des Templates.',
    'fs.heading': 'Font-Sets',
    'fs.name': 'Name des Font-Sets',
    'fs.phName': 'z. B. Broadcast',
    'fs.variations': 'Variationen',
    'fs.addVariation': '+ Hinzufügen',
