...
### Changed
- **README Feature List**: A setup is now something you can put down and pick up, background and framing included, which the list did not say.
...
- **Manuals**: The interface and saving chapters said the background image was neither stored nor saved, and that a format change keeps the same framing. Both are now wrong, and both were rewritten in German and English.
