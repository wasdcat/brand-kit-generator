...
> Die Adresszeile beginnt mit `http://`, und im Vorschaubereich rechts erscheint das Overlay auf einem Karomuster. Steht dort stattdessen „Das Template konnte nicht gerendert werden“, wurde die Datei per Doppelklick geöffnet.
...
**2. Text eingeben.** Der Bereich *Erstellen* ist beim Start geöffnet. Tragen Sie unter *Inhalt dieses Posts* Ihren Titel ein. Die Vorschau zieht sofort nach.
...
**5. Exportieren.** Unten rechts erzeugt **PNG (`*Format*`)** (etwa **PNG (9:16)**) die Datei für das gerade gewählte Format. **ZIP (alle Formate)** legt alle ausgewählten Formate zusammen in ein Archiv. (Im Bereich *Export* finden Sie die beiden Aktionen als **Aktuelle Ansicht als PNG herunterladen** und **Alle Formate als ZIP-Paket exportieren**.)
...
1. **Unternehmen** (Bereich *Unternehmen*): Name, Slogan, Copyright-Zeile und Logo. Das ändert sich selten und steckt in fast jedem Template.
2. **Produkt** (Bereich *Produkte*): Für jede Sendung, jedes Spiel oder jede Reihe ein eigener Eintrag mit Titel und Logo.
3. **Farbset** (Bereich *Farbset*): Die Hausfarben als eigenes Set anlegen, statt jedes Mal die Standardfarben zu nehmen.
