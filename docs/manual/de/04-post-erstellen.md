...
Ein leeres Feld hinterlässt keine Lücke. Lassen Sie *Tag 2* frei, verschwindet der zweite Chip ganz — samt seines Abstands, nicht als leerer Kasten. Dasselbe gilt für alle Textplatzhalter und für Logos.

Damit lässt sich dasselbe Template unterschiedlich dicht bespielen, ohne es anzupassen.

### Zu langer Text

Manche Templates begrenzen die Zeilenzahl, etwa den Titel auf zwei Zeilen. Was darüber hinausgeht, wird beim Export mit Auslassungspunkten abgeschnitten — an einer Wortgrenze, mit einem echten `…` in der Datei.

In der Vorschau sehen Sie das Abschneiden bereits. Wenn Ihnen der gekürzte Titel nicht gefällt, kürzen Sie ihn selbst, statt die Kürzung dem Werkzeug zu überlassen.

## Die Vorschau folgt mit

Jede Eingabe schlägt nach etwa einer Vierzigstelsekunde in der Vorschau durch. Sie tippen und sehen das Ergebnis, ohne etwas zu bestätigen.

Gerendert wird immer das gerade gewählte Format. Beim Wechsel auf ein anderes Format wird neu aufgebaut — deshalb blinkt der Statuspunkt links oben kurz gelb.
